...
const footerGroups = [
	{ links: [{ label: "About BizMatch", to: "/about" }, { label: "How matching works", to: "/about" }, { label: "Find partners", to: "/find-partners" }] },
